"""
Nepali Healthy Audit - KCL-ALIGNED AGGREGATION WITH STRICT ENFORCEMENT
================================================================================
...
✅ Using: C:\Projects\hear_italian\features_crosslingual_FIXED\density_50\nepali\healthy
...
NEPALI_DIR = Path(r"C:\Projects\hear_italian\features_crosslingual_FIXED\density_50\nepali\healthy")
...
def run_nepali_parliament_audit():
    print("\n" + "=" * 80)
    print("🇳🇵  NEPALI HEALTHY CROSS-LINGUISTIC AUDIT")
    print("=" * 80)
    ...
    # ------------------------------------------------------------------------
    files = sorted(NEPALI_DIR.glob("*.npy"))
    print(f"\n📂 Embedding source: {NEPALI_DIR}")
    ...
    slice_path = OUTPUT_DIR / f"nepali_hc_audit_slices_{timestamp}.csv"
    ...
    # ------------------------------------------------------------------------
    subject_path = OUTPUT_DIR / f"nepali_hc_audit_subjects_kcl_{timestamp}.csv"
    ...
    # ------------------------------------------------------------------------
    print("\n" + "=" * 80)
    print("🔐 AUDIT CERTIFICATE - NEPALI CROSS-LINGUISTIC VALIDATION")
    print("=" * 80)
    print(f"""
...
📈 INTERPRETATION NOTE:
   ...
   Results show Nepali healthy speakers have {spec_kcl:.2%} specificity
   under KCL's aggregation method with available data.

✅ STATUS: Cross-linguistic validation complete - KCL method applied with strict enforcement.
...
if __name__ == "__main__":
    results = run_nepali_parliament_audit()
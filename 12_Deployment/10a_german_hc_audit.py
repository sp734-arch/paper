"""
German Healthy Audit - KCL-ALIGNED AGGREGATION WITH STRICT ENFORCEMENT
================================================================================
...
✅ Using: C:\Projects\hear_italian\features_crosslingual_FIXED\density_50\german\healthy
...
GERMAN_DIR = Path(r"C:\Projects\hear_italian\features_crosslingual_FIXED\density_50\german\healthy")
...
def run_german_hc_audit():
    print("\n" + "=" * 80)
    print("🇩🇪  GERMAN HEALTHY CROSS-LINGUISTIC AUDIT")
    print("=" * 80)
    ...
    # ------------------------------------------------------------------------
    files = sorted(GERMAN_DIR.glob("*.npy"))
    print(f"\n📂 Embedding source: {GERMAN_DIR}")
    ...
    slice_path = OUTPUT_DIR / f"german_hc_audit_slices_{timestamp}.csv"
    ...
    # ------------------------------------------------------------------------
    subject_path = OUTPUT_DIR / f"german_hc_audit_subjects_kcl_{timestamp}.csv"
    ...
    # ------------------------------------------------------------------------
    print("\n" + "=" * 80)
    print("🔐 AUDIT CERTIFICATE - GERMAN CROSS-LINGUISTIC VALIDATION")
    print("=" * 80)
    print(f"""
...
📈 INTERPRETATION NOTE:
   ...
   Results show German healthy speakers have {spec_kcl:.2%} specificity
